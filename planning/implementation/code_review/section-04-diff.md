diff --git a/src/checks/log_md.rs b/src/checks/log_md.rs
new file mode 100644
index 0000000..508f7dd
--- /dev/null
+++ b/src/checks/log_md.rs
@@ -0,0 +1,124 @@
...
+pub mod log_md;
 pub mod okf;
diff --git a/tests/fixtures/okf/log_date_heading/fail/fail.md b/tests/fixtures/okf/log_date_heading/fail/fail.md
new file mode 100644
index 0000000..aad423b
--- /dev/null
+++ b/tests/fixtures/okf/log_date_heading/fail/fail.md
@@ -0,0 +1,7 @@
+## 2026-01-15
+
+Notes.
...
+
+Bad date notes.
diff --git a/tests/fixtures/okf/log_date_heading/pass/pass.md b/tests/fixtures/okf/log_date_heading/pass/pass.md
new file mode 100644
index 0000000..3ef34e6
--- /dev/null
+++ b/tests/fixtures/okf/log_date_heading/pass/pass.md
@@ -0,0 +1,7 @@
+## 2026-01-15
+
+Notes for this day.
