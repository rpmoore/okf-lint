...
Generate content for section `section-04-log-checks` (filename: `section-04-log-checks.md`).
...
for `section-04-log-checks` to understand what this section should contain.
...
`/home/rpmoore/code/okf-lint/planning/sections/section-04-log-checks.md`
