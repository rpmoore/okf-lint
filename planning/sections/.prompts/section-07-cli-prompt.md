...
Generate content for section `section-07-cli` (filename: `section-07-cli.md`).
...
for `section-07-cli` to understand what this section should contain.
...
`/home/rpmoore/code/okf-lint/planning/sections/section-07-cli.md`
