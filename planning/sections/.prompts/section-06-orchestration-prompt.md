...
Generate content for section `section-06-orchestration` (filename: `section-06-orchestration.md`).
...
for `section-06-orchestration` to understand what this section should contain.
...
`/home/rpmoore/code/okf-lint/planning/sections/section-06-orchestration.md`
