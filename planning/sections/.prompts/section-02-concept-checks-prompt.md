...
Generate content for section `section-02-concept-checks` (filename: `section-02-concept-checks.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/rpmoore/code/okf-lint/planning/claude-plan.md` - Full implementation plan
2. `/home/rpmoore/code/okf-lint/planning/claude-plan-tdd.md` - Test stubs for each section
3. `/home/rpmoore/code/okf-lint/planning/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-concept-checks` to understand what this section should contain.
...
`/home/rpmoore/code/okf-lint/planning/sections/section-02-concept-checks.md`
