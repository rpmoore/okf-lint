...
Generate content for section `section-05-style-checks` (filename: `section-05-style-checks.md`).
...
for `section-05-style-checks` to understand what this section should contain.
...
`/home/rpmoore/code/okf-lint/planning/sections/section-05-style-checks.md`
