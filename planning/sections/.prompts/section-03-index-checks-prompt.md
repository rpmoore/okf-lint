...
Generate content for section `section-03-index-checks` (filename: `section-03-index-checks.md`).
...
for `section-03-index-checks` to understand what this section should contain.
...
`/home/rpmoore/code/okf-lint/planning/sections/section-03-index-checks.md`
