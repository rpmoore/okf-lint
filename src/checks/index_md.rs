...
mod tests {
    ...
    #[test]
    fn multi_line_stray_paragraph_emits_one_diagnostic_per_line() {
        let content = "# Title\n\nstray line one\nstray line two\n\n- Item\n";
        assert_eq!(
    ...
    #[test]
    fn root_with_no_frontmatter_has_no_frontmatter_placement_diagnostics() {
        let content = "# Root Index\n\n- [Foo](foo.md)\n";
        assert_eq!(check_index(content, true), vec![]);
    }

    #[test]
    fn root_with_empty_frontmatter_mapping_has_no_diagnostics() {
        let content = "---\n---\n# Root Index\n\n- [Foo](foo.md)\n";
        assert_eq!(check_index(content, true), vec![]);
    }
