...
pub fn run_fmt(
    ...
    let remaining = if check {
        ...
        lint::lint_bundle(root, max_line_length)?
    };
...
mod tests {
    ...
    fn fmt_root_not_found() {
        ...
        let result = run_fmt(missing, 100, 4, false);
    ...
    fn fmt_root_is_a_file() {
        ...
        let result = run_fmt(&file_path, 100, 4, false);
    ...
    fn fmt_writes_fixed_content_and_reports_no_remaining_style_diagnostics() {
        ...
        let outcome = run_fmt(dir.path(), 100, 4, false).unwrap();
    ...
    fn fmt_check_mode_does_not_write_files() {
        ...
        let outcome = run_fmt(dir.path(), 100, 4, true).unwrap();
